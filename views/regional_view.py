...
def render_regional_view(df: pd.DataFrame, palette: dict):
    ...
    st.markdown(f"<h4 style='color:{text_pri}; margin:0; font-family:{font_title};'>PHÂN TÍCH ĐỐI CHIẾU VÙNG MIỀN</h4>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='font-family: {font_title}; font-size: 13px; font-weight: 700; color: {text_pri}; text-transform: uppercase; margin-bottom: 8px; border-bottom: 1px solid {border_col}; padding-bottom: 4px;'>Chỉ Số Quan Trắc Tổng Quan Theo Địa Giới</div>", unsafe_allow_html=True)
    ...
    with col1:
        st.markdown(f"""
        <div style="border: 1px solid {border_col}; border-radius: 4px; padding: 12px 14px; background: {card_bg}; font-family: {palette['font_body']};">
            <div style="font-family: {palette['font_title']}; font-size: 12px; font-weight: 700; color: {text_sec}; text-transform: uppercase;">Tỷ lệ cháy (Bejaia)</div>
    ...
    with col2:
        ...
        st.markdown(f"""
        <div style="border: 1px solid {border_col}; border-radius: 4px; padding: 12px 14px; background: {card_bg}; font-family: {palette['font_body']};">
            <div style="font-family: {palette['font_title']}; font-size: 12px; font-weight: 700; color: {text_sec}; text-transform: uppercase;">Tỷ lệ cháy (Sidi-Bel Abbes)</div>
    ...
    with col3:
        st.markdown(f"""
        <div style="border: 1px solid {border_col}; border-radius: 4px; padding: 12px 14px; background: {card_bg}; font-family: {palette['font_body']};">
            <div style="font-family: {palette['font_title']}; font-size: 12px; font-weight: 700; color: {text_sec}; text-transform: uppercase;">Nhiệt độ TB (Bejaia vs Sidi)</div>
    ...
    with col4:
        st.markdown(f"""
        <div style="border: 1px solid {border_col}; border-radius: 4px; padding: 12px 14px; background: {card_bg}; font-family: {palette['font_body']};">
            <div style="font-family: {palette['font_title']}; font-size: 12px; font-weight: 700; color: {text_sec}; text-transform: uppercase;">Độ ẩm TB (Bejaia vs Sidi)</div>
    ...
    st.markdown(f"<div style='font-family: {font_title}; font-size: 13px; font-weight: 700; color: {text_pri}; text-transform: uppercase; margin-bottom: 8px; border-bottom: 1px solid {border_col}; padding-bottom: 4px;'>Hồ Sơ Chuẩn Hóa Các Chỉ Số FWI (Radar Profile)</div>", unsafe_allow_html=True)
    ...
    fig_radar.update_layout(
        polar=dict(
            ...
            angularaxis=dict(gridcolor=grid_col, tickfont=dict(size=11, color=text_pri, family=palette.get("font_title", "Montserrat, sans-serif"))),
            bgcolor=plot_bg
        ),
        showlegend=True,
        height=360,
    ...
    st.markdown("<div style='height: 12px;'></div>", unsafe_allow_html=True)
    st.markdown(f"<div style='font-family: {font_title}; font-size: 13px; font-weight: 700; color: {text_pri}; text-transform: uppercase; margin-bottom: 8px; border-bottom: 1px solid {border_col}; padding-bottom: 4px;'>Phân Bố Tham Số Khí Tượng Chi Tiết (Boxplot)</div>", unsafe_allow_html=True)
    ...
    st.markdown("<div style='height: 12px;'></div>", unsafe_allow_html=True)
    st.markdown(f"<div style='font-family: {font_title}; font-size: 13px; font-weight: 700; color: {text_pri}; text-transform: uppercase; margin-bottom: 8px; border-bottom: 1px solid {border_col}; padding-bottom: 4px;'>Tần Suất Số Ngày Cháy Theo Từng Tháng</div>", unsafe_allow_html=True)
    ...
    fig_bar.update_layout(
        ...
        plot_bgcolor=plot_bg,
        font={"family": palette.get("font_body", "Lato, sans-serif"), "color": text_pri, "size": 12},
        xaxis=dict(gridcolor=grid_col, title=dict(font=dict(color=text_pri, family=palette.get("font_title", "Montserrat, sans-serif"))), tickfont=dict(color=text_sec, family=palette.get("font_body", "Lato, sans-serif"))),
        yaxis=dict(gridcolor=grid_col, title=dict(font=dict(color=text_pri, family=palette.get("font_title", "Montserrat, sans-serif"))), tickfont=dict(color=text_sec, family=palette.get("font_body", "Lato, sans-serif"))),
        legend=dict(font=dict(color=text_pri, family=palette.get("font_body", "Lato, sans-serif"))),
        margin=dict(l=30, r=30, t=20, b=30)
    )
